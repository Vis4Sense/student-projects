...
# Packages Required: matplotlib, pandas
#------------------------------------------------------------#
...
# Define the Work Packages & their 'Start' and 'End' dates
data = {
    'Task': [
...
# Create the DataFrame for the Gantt chart
...
# Plot the Gantt chart with defined size
...
for i, task in df.iterrows():
    ...
    if color not in custom_colors:
        ...
        custom_colors[color] = label

# Format the y-axis
ax.set_yticks(range(len(df)))
ax.set_yticklabels(df['Task'])

# Format the x-axis with weekly ticks from 23rd June to 12th September 2025 (deadline)
